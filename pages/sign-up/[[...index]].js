...
export default function SignUpPage() {
  return (
    <>
      <Head><title>Create Account — FintelligenceIQ</title></Head>
...
// Without this, Next.js tries to SSR this page during build,
// ClerkProvider throws (no valid key at build time), and the
// ENTIRE build fails — causing 404s on all Clerk-related routes.
