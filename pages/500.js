...
export default function ServerError() {
  return (
    <>
      <Head><title>500 — Server Error | FintelligenceIQ</title></Head>
      <div style={{ minHeight:"100vh", background:"#040b18", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", fontFamily:"Manrope,system-ui,sans-serif", color:"#EEF4FF", padding:"24px", textAlign:"center" }}>
        ...
        <div style={{ fontSize:80, fontWeight:800, color:"#102030", fontFamily:"Sora,sans-serif", lineHeight:1 }}>500</div>
        <div style={{ fontSize:22, fontWeight:700, marginTop:16, marginBottom:10 }}>Something went wrong</div>
        <div style={{ fontSize:14, color:"#6B8DB5", marginBottom:32 }}>A server error occurred. Please try again in a moment.</div>
        <Link href="/">
